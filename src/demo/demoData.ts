...
export const DEMO_INTERACTIONS = [
  ...
  { id: "i7", client_id: "c1", user_id: DEMO_SELLER.id, result: "presupuesto", total_amount: 1200000, currency: "ARS", interaction_date: "2026-04-20", follow_up_date: "2026-05-10", notes: "Pedido grande de eucalipto", estimated_loss: null, clients: { name: "Forestal del Sur S.A.", province: "Misiones", segment: "Forestal" }, interaction_lines: [{ products: { name: "Semillas de eucalipto" }, quantity: 500, unit_price: 2400, line_total: 1200000 }] },
  { id: "i8", client_id: "c4", user_id: DEMO_SELLER.id, result: "presupuesto", total_amount: 950000, currency: "ARS", interaction_date: "2026-04-22", follow_up_date: "2026-05-12", notes: "Madera para obra nueva", estimated_loss: null, clients: { name: "Constructora Andes", province: "Mendoza", segment: "Construcción" }, interaction_lines: [{ products: { name: "Madera estructural" }, quantity: 30, unit_price: 31667, line_total: 950000 }] },
  { id: "i9", client_id: "c3", user_id: DEMO_OWNER.id, result: "presupuesto", total_amount: 15000, currency: "USD", interaction_date: "2026-04-25", follow_up_date: "2026-05-15", notes: "Proyecto exportación madera certificada", estimated_loss: null, clients: { name: "Industrias Metalúrgicas del Plata", province: "Buenos Aires", segment: "Industrial" }, interaction_lines: [] },
  { id: "i10", client_id: "c2", user_id: DEMO_SELLER.id, result: "presupuesto", total_amount: 360000, currency: "ARS", interaction_date: "2026-04-28", follow_up_date: "2026-05-08", notes: "Tratamiento fitosanitario lote 5", estimated_loss: null, clients: { name: "Agro Campos Verdes", province: "Córdoba", segment: "Agropecuario" }, interaction_lines: [{ products: { name: "Servicio fitosanitario" }, quantity: 1, unit_price: 360000, line_total: 360000 }] },

  // Seguimientos pendientes
  { id: "i11", client_id: "c6", user_id: DEMO_SELLER.id, result: "seguimiento", total_amount: null, currency: "ARS", interaction_date: "2026-04-28", follow_up_date: "2026-05-06", notes: "Llamar para confirmar pedido semillas", estimated_loss: null, clients: { name: "Comercializadora Norte", province: "Tucumán", segment: "Comercio" }, interaction_lines: [] },
  { id: "i12", client_id: "c4", user_id: DEMO_SELLER.id, result: "seguimiento", total_amount: null, currency: "ARS", interaction_date: "2026-04-29", follow_up_date: "2026-05-07", notes: "Enviar muestras de madera", estimated_loss: null, clients: { name: "Constructora Andes", province: "Mendoza", segment: "Construcción" }, interaction_lines: [] },
  { id: "i13", client_id: "c7", user_id: DEMO_OWNER.id, result: "seguimiento", total_amount: null, currency: "ARS", interaction_date: "2026-04-30", follow_up_date: "2026-05-05", notes: "Visita técnica programada", estimated_loss: null, clients: { name: "Estancia La Esperanza", province: "Santa Fe", segment: "Agropecuario" }, interaction_lines: [] },

  // Seguimientos vencidos
  { id: "i14", client_id: "c1", user_id: DEMO_SELLER.id, result: "seguimiento", total_amount: null, currency: "ARS", interaction_date: "2026-04-15", follow_up_date: "2026-05-01", notes: "Cotización adicional pendiente", estimated_loss: null, clients: { name: "Forestal del Sur S.A.", province: "Misiones", segment: "Forestal" }, interaction_lines: [] },
  { id: "i15", client_id: "c5", user_id: DEMO_OWNER.id, result: "seguimiento", total_amount: null, currency: "ARS", interaction_date: "2026-04-16", follow_up_date: "2026-05-02", notes: "Esperando respuesta licitación", estimated_loss: null, clients: { name: "Gobierno Provincial de Salta", province: "Salta", segment: "Gobierno" }, interaction_lines: [] },
  { id: "i16", client_id: "c8", user_id: DEMO_SELLER.id, result: "seguimiento", total_amount: null, currency: "ARS", interaction_date: "2026-04-18", follow_up_date: "2026-05-03", notes: "Reactivar relación comercial", estimated_loss: null, clients: { name: "Frío Industrial S.R.L.", province: "Buenos Aires", segment: "Industrial" }, interaction_lines: [] },
